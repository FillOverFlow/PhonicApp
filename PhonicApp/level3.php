		...
		<div class="row">
			<div class="col-lg-12">
				...
				<div id="grid-container" class="cbp-l-grid-projects">
					...
					$sql = "SELECT * FROM lesson_detail where level = '3' order by lesson_no";
						...
						<li class="cbp-item graphic">
							<div class="cbp-caption">
								<div class="cbp-caption-defaultWrap">
									<img src="<?php echo $row["small_image"];?>" alt="" />
								</div>
								<div class="cbp-caption-activeWrap">
									<div class="cbp-l-caption-alignCenter">
										<div class="cbp-l-caption-body">
											...
											<a href="lesson_show.php?lesson_id=<?php echo $row["lesson_id"];?>" class="cbp-l-caption-buttonRight">เข้าเรียน</a>
										</div>
									</div>
								</div>
							</div>
