              ...
              <div class="card">
                    ...
                    <div class="form-group row">
                        <label for="fname" class="col-sm-3 text-right control-label col-form-label">รูปบทเรียน</label>
                            ...
                            <hr>
                            <h4 class="card-title">เพิ่มหน้า&และคำศัพท์</h4>
                            
                            <div class="form-group row">
                                <div class="col-sm-9">
                                <div><a id="btn-page" class="btn btn-success">เพิ่มหน้า</a></div>
                                <br>
                                ...
                                <div id="accordion">
                                    ...
                                    <div id="collapseOne" class="collapse " data-parent="#accordion">
                                        <div  class="card-body" style="background-color: #ffffcc;">
                                            ...
                                            <a href="#" ><span><i class="fa fa-plus-circle" aria-hidden="true"></i></span></a>
                                            <!-- คำศัพท์ คำแรก -->
                                            <hr>
                                            <p>1</p>
                                            <div class="form-group row">
                        ...
                        <div class="border-top">
                            <div class="card-body">
                                <button  class="btn btn-primary">เพิ่มบทเรียน</button>
                            </div>
                        </div>
                    </form>
                </div>
