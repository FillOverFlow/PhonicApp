...
<body>
      ...
      <div class="container-fluid">
        ...
        <div class="card">
          <div class="card-body">
            ...
            <!-- form first -->
            <form method="post" action="script/addexam_script.php" enctype="multipart/form-data">
              <div class="row">
                <div class="col-sm-2">
                     ...
                     <div class="card-header" id="headingOne">
                        <h5 class="mb-0">
                          <a data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                            ...
                            <span>เลือกบทเรียนที่ต้องการเพิ่ม Exam</span>
                          </a>
                        </h5>
                    </div>
                    <div class="card-body">
  ...
  <script>
    ...
    $(document).off('change',"#quiz_style");
    $(document).on('change',"#quiz_style",function(){
      var quiz_style = $('.quiz_style'+window.value).val();
      if(quiz_style == 0){
        console.log("choose:"+quiz_style)
